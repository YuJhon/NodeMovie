...
var router = require('./src/routers/movieRouter'); //引用自定义的路由文件
var mongoose = require('mongoose');                //引入mongoose模块
var Conf = require('./src/config/dbConfig');      //引入数据库配置文件，提供了连接数据库所需的参数
...
//http://localhost:3000/movie 下的请求都经过router文件拦截
